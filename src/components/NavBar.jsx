  ...
  return (
    <>
      <nav
        ...
        } w-screen pt-3 sticky text-gray-50 fixed top-0`}
      >
        {checkMobile ? 
                <>
    ...
    return(
        <>
            <label className="inline-flex items-center cursor-pointer">
                <input type="checkbox" checked={!isDark} onClick={() => {useDarkMode(); setIsDark(!isDark)}} className="sr-only peer outline-none"/>

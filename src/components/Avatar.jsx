    ...
    return(
        <div className="flex flex-col DropDownProfile z-100">
            <ul className="flex flex-col z-10">
                ...
                {isLogin() ? <>
                    <li className="hover:bg-slate-200 cursor-pointer" onClick={() => window.location.href = "/favorites"}>
                        <div className="flex items-center mx-5 my-3 gap-2">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
                    ...
                    <li className="hover:bg-slate-200 cursor-pointer" onClick={() => window.location.href = "/my-recipe"}>
                        <div className="flex items-center mx-5 my-3 gap-2">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
                ...
                {(window.sessionStorage.getItem("isAdmin") == "true") ? 
                    <li className="hover:bg-slate-200 cursor-pointer" onClick={() => window.location.href = "/admin"}>
                        <div className="flex items-center mx-5 my-3 gap-2">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
